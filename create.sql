...
"ID" NUMBER GENERATED ALWAYS AS IDENTITY(START WITH 1 INCREMENT BY 1) PRIMARY KEY,
"CARD_NUMBER" NUMBER GENERATED ALWAYS AS IDENTITY(START WITH 1 INCREMENT BY 1),
"DATE" DATE NOT NULL,
...
CREATE SEQUENCE incr_seq START WITH 1;
CREATE OR REPLACE TRIGGER incr_p_custom
BEFORE INSERT ON P_CUSTOMERS
FOR EACH ROW
BEGIN
  SELECT incr_seq.NEXTVAL
